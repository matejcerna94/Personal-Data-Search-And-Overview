...
import com.matejcerna.activity.DodajAdminaActivity;
import com.matejcerna.activity.ObrisiAdminaActivity;
import com.matejcerna.activity.PretraziAdminaZaUredivanjeActivity;
import com.matejcerna.activity.PrijavaActivity;
import com.matejcerna.activity.PrikazAdminaActivity;
import com.matejcerna.R;
import com.matejcerna.activity.TraziAdminaActivity;
...
public class AdminFragment extends Fragment {
   ...
   /* LinearLayout linearLayoutDodajAdmina;
    ...
    public void onLinearLayoutUrediAdminaClicked() {
        Intent i = new Intent(getActivity(), PretraziAdminaZaUredivanjeActivity.class);
        startActivity(i);
    }
